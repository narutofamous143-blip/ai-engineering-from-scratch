...
- [NielsRogge, Transformers-Tutorials — `BERT/Custom_Named_Entity_Recognition_with_BERT.ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/BERT/Custom_Named_Entity_Recognition_with_BERT.ipynb) — production fine-tuning path for the "BERT + task head" pattern Step 4 sketches. Pairs with the whole-word masking notebook (`..._only_first_wordpiece.ipynb`) for Exercise 2.
- [NielsRogge, Transformers-Tutorials — `BERT/Fine_tuning_BERT_(and_friends)_for_multi_label_text_classification.ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/BERT/Fine_tuning_BERT_(and_friends)_for_multi_label_text_classification.ipynb) — classification head wired to `[CLS]`, dataset pipeline, trainer loop.
- [mlabonne, LLM Course — LLM Fundamentals §4 (NLP)](https://github.com/mlabonne/llm-course#-llm-fundamentals) — positions encoder-only models vs decoders in the "when to pick what" framing this lesson uses.
- [Raschka, *LLMs-from-scratch* — Ch. 6 fine-tuning for classification](https://github.com/rasbt/LLMs-from-scratch/tree/main/ch06/01_main-chapter-code) — while it fine-tunes a decoder, the classification-head and training-loop shape transfers cleanly to BERT.
